/**
 * Thin fetch wrapper around WishDem.Customer.Api. Every real network call in
...
const ACCESS_TOKEN_KEY = "wishdem-customer-access-token";
const REFRESH_TOKEN_KEY = "wishdem-customer-refresh-token";
